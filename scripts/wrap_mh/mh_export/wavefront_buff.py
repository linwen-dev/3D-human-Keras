"""TEST Write to a buffer object instead of an obj to save cpu."""
...
def writeObjFile(path, objects, writeMTL=True, config=None, filterMaskedFaces=True, MTLbuff=None,):
    ...
    if writeMTL:
        fp = MTLbuff #open(mtlfile, 'w', encoding="utf-8")
        fp.write(
